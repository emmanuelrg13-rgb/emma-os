/* Emma OS v1.7.0 · 2026-09-03 · OpenAI/ChatGPT (GPT-5.5 Thinking)
...
(function(){
  ...
  const version = script?.dataset?.version || 'v1.7.0';
  const apps = [
    ...
    {id:'finanzas', icon:'$', name:'Finanzas', desc:'Control financiero M0/M1', href: base + 'apps/finanzas/', accent:'gold'},
