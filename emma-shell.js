/* Emma OS v1.7.1 · 2026-09-03 · OpenAI/ChatGPT (GPT-5.5 Thinking)
...
(function(){
  ...
  const version = script?.dataset?.version || 'v1.7.1';
  const apps = [
    ...
    {id:'finanzas', icon:'$', name:'Finanzas', desc:'Control financiero M0/M1/M2', href: base + 'apps/finanzas/', accent:'gold'},
