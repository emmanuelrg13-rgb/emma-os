...
- Apps Script v1.5.3 recibe partes temporales en la hoja EmmaOS_UploadChunks, arma el respaldo y luego guarda en EmmaOS_Backups.
...
3. Commit sugerido: Actualizar Emma OS a v1.5.3 Sync chunked upload.
4. Abre la app con ?v=1.5.3.
5. En Sync Sheets, copia el Apps Script v1.5.3.
